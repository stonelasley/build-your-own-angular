...
describe('parse', function () {
  ...
  it('looks up a four-part identifier path from the scope', function () {
  ...
  it('parses a computed access with another key property', function () {
  ...
  it('does not allow calling the function contructor', function () {
